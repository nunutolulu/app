<template>
    ...
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders" v-for="order in myOrder.records" :key="order.id">
                <!-- 每个table是一笔订单 -->
                <table class="order-item">
                    ...
                    <tbody>
                        <tr v-for="(orderDetail, index) in order.orderDetailList" :key="orderDetail.skuId">
                            <td width="60%">
                            ...
                            <!-- rowspan不能写死，为合并单元格，应该与订单中商品的种类相一致，即length -->
                            <!-- 只需要一个姓名，合并在一起，即只需要第一个 -->
